...
<div class="svg-container">
	...
	{#each Array(moduleCountY) as _, yi}
			...
			<g transform="translate({xi * triangleWidth * 4 + getOffset(xi, yi)},{yi * triangleHeight * 6})">
				<g>
					<polygon points="0 0, 
									{triangleWidth+offset1x+offset2x-midpointOffsetX} {-triangleHeight-offset1y+offset2y+midpointOffsetY}, 
									{triangleWidth+offset2x-midpointOffsetX} {triangleHeight+midpointOffsetY}, 
									{triangleWidth -offset1x+offset2x-midpointOffsetX} {3 * triangleHeight+offset1y+offset2y+midpointOffsetY}, 
									0 {4 * triangleHeight}, 
									{0+midpointOffsetX} {2 * triangleHeight+midpointOffsetY}" stroke="black" stroke-width="0" fill="#e67d3c" />
					<polygon points="{0+offset1x+offset2x-midpointOffsetX} {0-offset1y+offset2y+midpointOffsetY}, 
									{triangleWidth} {-triangleHeight}, 
									{triangleWidth+midpointOffsetX} {triangleHeight+midpointOffsetY}, {
									triangleWidth} {3 * triangleHeight}, 
									{0-offset1x+offset2x-midpointOffsetX} {(4 * triangleHeight)+offset1y+offset2y+midpointOffsetY}, 
									{offset2x-midpointOffsetX } {triangleHeight+midpointOffsetY}" stroke="black" stroke-width="0" fill="#995328" transform="translate({triangleWidth}, {-triangleHeight})"/>
				</g>
